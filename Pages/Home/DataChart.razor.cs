...
public partial class DataChart : ProCompontentBase
{
    ...
    protected override void OnInitialized()
    {
        ...
        _orderChart = new
        {
            ...
            Series = new[]
            {
                    new
                    {
                        name= "series-1",
                        Type= "line",
                        Data= DataChartService.GetOrderChartData(),
                        Color= "#4318FF",
                        SymbolSize= 6,
                        Symbol= "circle",
                    }
        ...
        _profitChart = new
        {
            ...
            Series = new[]
            {
                    ...
                    {
                        Type= "bar",
                        Data= DataChartService.GetProfitChartData(),
                        Color= "#4318FF"
                    }
                },
            Grid = new
        ...
        int[] _earningsChartData = DataChartService.GetEarningsChartData();
        ...
        var _revenueReportChartData = DataChartService.GetRevenueReportChartData();
            ...
            Series = new[]
            {
                    new
                    {
                        ...
                        Data= new []
                        {
                            new
                            {
                              Value=DataChartService.GetBudgetChartData(),
                            }
                        },
                        Color="#4318FF",
                        SymbolSize=6,
